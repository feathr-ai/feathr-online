 ...
 * <ol>
 * A simple type, includes Boolean, Int, Long, Float, Double, String, Instant, or a null value.
 * A List type, nesting is allowed, means it can be a list with list or map as its element.
 * A Map type, the key must be non-null String, and the value can be any value type, nesting is allowed.
 * </ol>
