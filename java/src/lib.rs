...
#[no_mangle]
pub extern "system" fn Java_com_linkedin_feathr_online_PiperService_create(
    env: JNIEnv,
    _class: JClass,
    pipelines: JString,
    lookups: JString,
 ...
 */
#[no_mangle]
pub unsafe extern "system" fn Java_com_linkedin_feathr_online_PiperService_start(
    env: JNIEnv,
    _class: JClass,
    svc_handle: jlong,
    address: JString,
 ...
 */
#[no_mangle]
pub unsafe extern "system" fn Java_com_linkedin_feathr_online_PiperService_stop(
    _env: JNIEnv,
    _class: JClass,
    svc_handle: jlong,
) {
